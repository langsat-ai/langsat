...
MODEL_LABELS = {"Baseline": "GraphSAGE (default, labelled *Baseline*)", "SAGE": "GraphSAGE (full)", "GAT": "GATv2",
                "GIN": "GIN", "TabNet": "TabNet", "tabnet": "TabNet", "ft_transformer": "FT-Transformer (tabular)", "resnet": "ResNet (tabular)", "mlp_small": "MLP (tabular)", "mlp_baseline": "MLP (tabular)", "mlp_large": "MLP (tabular)", "unsupervised": "GraphMAE (self-supervised)", "lightgbm": "LightGBM (feature-plan table)"}
